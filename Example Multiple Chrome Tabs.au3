...
With test("Multiple Chrome Tabs test")
	...
	With teststep("Launch first Chrome browser and first tab")
		...
		MsgBox(0, "Example Multiple Chrome Tabs", "Chrome #1 launched and new page (tab) #1")
	EndWith
	...
	With teststep("Launch second Chrome browser and first tab")
		...
		MsgBox(0, "Example Multiple Chrome Tabs", "Chrome #2 launched and new page (tab) #1")
	EndWith
	...
	With teststep("Add a second tab to the first Chrome browser")
		...
		MsgBox(0, "Example Multiple Chrome Tabs", "New page (tab) #2 added to Chrome #1")
	EndWith
	...
	With teststep("Add a second tab to the second Chrome browser")
		...
		MsgBox(0, "Example Multiple Chrome Tabs", "New page (tab) #2 added to Chrome #2")
	EndWith

	With teststep("Close the first Chrome browser")
		$chrome1.close()
		MsgBox(0, "Example Multiple Chrome Tabs", "Chrome #1 closed")
	EndWith

	With teststep("Close the second Chrome browser")
		$chrome2.close()
		MsgBox(0, "Example Multiple Chrome Tabs", "Chrome #2 closed")
	EndWith
