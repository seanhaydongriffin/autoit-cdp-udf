...
The CDP UDF automates the browser directly through the browser's developer tools (DevTools) protocol.<br><br>
<p align="left">
...
The modern way to automate via devtools protocol:<br><br>
<p align="left">
