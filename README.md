...
- Extremely lightweight (no bulky tech stack, no Python, no Node.js, no ChromeDriver, no npm, no reporters, no trace viewers)
...
- Single self-contained scripts (executables with all dependencies) that can automate Chrome on any Windows machine
